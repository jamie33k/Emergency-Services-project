-- Emergency Services Database Schema
-- PostgreSQL Database Setup

-- Create the main database (run this first if creating a new database)
-- CREATE DATABASE emergency_services;
...
-- Emergency contacts table for additional contacts
